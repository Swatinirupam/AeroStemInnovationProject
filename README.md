# AeroSTEM Innovation Challenge

<!-- Fill in the two lines below for this challenge. -->
**Challenge:** Clean Power Flight
**Linked SDG:** SDG 7: Affordable and Clean Energy

A whole-school aviation STEM project website. Pupils from Year 1 to Year 11 work on one shared challenge at
...
## How to publish it online with GitHub Pages

These steps let anyone with the link view the site. No coding needed.
...
7. Wait a minute, then refresh the Pages screen. GitHub shows a link like
   `https://your-username.github.io/aerostem-innovation-challenge/`. That is your live site to share.

To update the site later, upload the changed files to the same repository. The live link refreshes automatically.

## Accessibility

The site uses readable text, strong colour contrast, keyboard-friendly tabs and alt text on images, so it works
